  ...
  return (
    <div className="min-h-screen flex flex-col justify-between items-center px-4 py-24 md:py-32 bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${BackgroundPattern})` }}>
      <div className="w-full max-w-xl bg-white/90 rounded-md p-8 shadow-lg">
        <h1 className="text-center text-3xl md:text-4xl font-light mb-8 uppercase tracking-wide">
          Lakukan Pembayaran <br /> Sekarang
        </h1>
        <p className="mb-6 text-center">Untuk melanjutkan pesanan Anda, silakan lakukan pembayaran dengan scan QR berikut:</p>
        ...
        <div className="text-center text-xl md:text-3xl font-medium tracking-wide">
          {String(Math.floor(timeLeft / 60)).padStart(2, "0")}:{String(timeLeft % 60).padStart(2, "0")} DETIK
        </div>
        ...
        {showModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50">
            <div className="bg-white p-8 mx-4 rounded-md shadow-md text-center max-w-md w-full">
              <h2 className="text-3xl md:text-4xl font-light mb-4 uppercase">Terima Kasih</h2>
              <p className="text-sm">
                Pembayaran Anda telah berhasil. <br /> Mengalihkan ke beranda...
              </p>
            </div>
          </div>
        )}
